...
import IconTraveller from 'assets/images/icons/icon_traveler.svg'
            ...
            <div className="row align-item-center">
                <div className="col-auto pr-5" style={{ width: 520, height: 410 }}>
                    ...
                    <div className="row" style={{marginTop: 80}}>
                        <div className="col-auto" style={{marginRight: 25 }}>
                            <img width="36" height="36" src={IconTraveller} alt={`${props.data.travelers} Travelers`} />
                            <h6 className="mt-3">
                ...
                <div className="col-6 pl-5">
                    <div style={{width: 540}}>
                        ...
                        <img src={ImageHeroFrame} alt="Room with couches" className="img-fluid position-absolute" style={{margin: '0 -15px -15px 0'}}/>
                    </div>
                </div>
            </div>
        </section>
